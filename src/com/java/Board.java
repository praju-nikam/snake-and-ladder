...
public class Board {
    ...
    Player player2;
    Dice dice;
//This is constructor we are initialising for the board
    public Board()
    {
        // for loop using initialising Number 1 to 100 on Board
        int c = 100;
        for( int j = 0; j<=9; j++ )
        {
        ...
        //Initialising snake position on Board
        ...
        //Initialising Ladder position on Board
    ...
    public void throwDice( String plyr )
    {
        ...
        if( plyr.equals("player1") )
        {
            ...
            else if( ( tile[i][j].ladder != null ) && ( tile[i][j].snake == null ) )
            {
                ...
                this.player1.position = tile[i][j].ladder.endPosition;
                System.out.println( "Player1's Current Position = "+this.player1.position );
                System.out.println( "Player2's Current Position = "+this.player2.position );
            }
            //Player got Snake Bite
            else if( ( tile[i][j].ladder == null ) && ( tile[i][j].snake != null ) )
            {
                System.out.println( "Oops! Player1 You Got Snake Bite!" );
                this.player1.position = tile[i][j].snake.endPosition;
                System.out.println( "Player1's Current Position = "+this.player1.position );
                System.out.println( "Player2's Current Position = "+this.player2.position );
            }
        }
        else if( plyr.equals("player2") )
        {
            ...
            else if( ( tile[i][j].ladder != null ) && ( tile[i][j].snake == null ) )
            {
                ...
                this.player2.position = tile[i][j].ladder.endPosition;
                System.out.println( "Player1's Current Position = "+this.player1.position );
                System.out.println( "Player2's Current Position = "+this.player2.position );
            }
            else if( ( tile[i][j].ladder == null ) && ( tile[i][j].snake != null ) )
            {
                ...
                this.player2.position = tile[i][j].snake.endPosition;
                System.out.println( "Player1's Current Position = "+this.player1.position );
                System.out.println( "Player2's Current Position = "+this.player2.position );
            }
        }
